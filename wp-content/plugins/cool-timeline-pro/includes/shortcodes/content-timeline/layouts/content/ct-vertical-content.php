    ...
    $ctl_v_html .= '<div data-aos="'.esc_attr($ctl_animation).'"  id="' . esc_attr($row). '" class="timeline-content  clearfix ' .esc_attr($even_odd) . '  ' . esc_attr($container_cls) . '  ht-content-'.esc_attr($design).'">';
     ...
     if(in_array($active_design,array("design-2","default","design-4","design-5","design-6"))){
         if($active_design=="design-6"){
            ...
            $ctl_v_html .= '<h2 class="content-title"><a target="'.$target.'" href="'.esc_url(get_the_permalink($post_id)). '">' . get_the_title($post_id) . '</a></h2>';
         }
       }  
             ...
             $ctl_v_html .= '<h2 class="content-title-simple"><a target="'.$target.'" href="' .esc_url(get_the_permalink($post_id)). '">' . get_the_title($post_id) . '</a></h2>';
              }
